...
class tLine: public tPoint
{
    ...
    public:
        ...
        double get_y2();
        double *move_line();
        double *rotate_line(double angle);
};
...
class tRectangle: public tLine
{
    ...
    public:
        ...
        double get_x4();
        double get_y4();
        double *move_rectangle();
        double *rotate_rectangle(double angle);
};
...
class tTriangle: public tLine
{
    ...
    public:
        ...
        double get_x3();
        double get_y3();
        double *move_triangle();
        double *rotate_triangle(double angle);
};
...
class tEllipse: public tPoint
{
    ...
    public:
        ...
        double get_radius2();
        double *move_ellipse();
        double *rotate_ellipse(double angle);
};
