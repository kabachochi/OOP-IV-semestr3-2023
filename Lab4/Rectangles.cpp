...
double *tLine::rotate_line(double angle)
{
    double *param = new double[4]; 
...
double *tRectangle::move_rectangle()
{
...
double *tRectangle::rotate_rectangle(double angle)
{
    double *param = new double[8]; 
    if (angle > 360) { angle = 0;}
...
double *tTriangle::move_triangle()
{
...
double *tTriangle::rotate_triangle(double angle)
{
    double *param = new double[6]; 
    if (angle > 360) { angle = 0;}
...
double *tEllipse::rotate_ellipse(double angle)
{
    double *param = new double[2]; 
    if (angle > 360) { angle = 0;}
